 ...
 *
 * Geometry2 is the core unit of renderable mesh data. It stores a
 ...
 *
 * Instances are usually created via the static @ref Geometry2::Create factory
 * method and populated with attributes using @ref Geometry2::AddAttribute.
 *
 * @code
...
public:
    ...
    /**
     * @brief Creates a shared instance of an empty @ref Geometry2.
     *

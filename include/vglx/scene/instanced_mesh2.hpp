 ...
 *
 * InstancedMesh2 stores a single geometry/material pair and renders it
 ...
 *
 * auto boxes = my_scene->Add(vglx::InstancedMesh2::Create(
...
public:
    ...
    /**
     * @brief Creates an instance of @ref InstancedMesh2.
     *
